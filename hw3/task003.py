...
# list = [int(input(f"{_ + 1}. Введите число: ")) for _ in range(int(input("Введите размер массива: ")))]
# n = int(input("Введите некоторое число: "))
# print(f' Это число встречается {list.count(n)} раза в массиве')
...
#     6
#     -> 5
list = [int(input(f"{i + 1}. Введите число: ")) for i in range(int(input("Введите размер массива: ")))]
n = int(input("Введите число и программа найдет наиболее прближенное к нему значение в массиве: "))
print(list)
list_diff =[]
for i in range(len(list)):
    diff = abs(list[i]-n)
    list_diff.append(diff)
print(f' Наиболее приближенное: {list[list_diff.index(min(list_diff))]}')
